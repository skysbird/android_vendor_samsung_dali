...
PRODUCT_COPY_FILES += \
	...
	vendor/samsung/dali/proprietary/lib/librpc.so:system/lib/librpc.so
...
PRODUCT_COPY_FILES += \
	...
	vendor/samsung/dali/proprietary/lib/libqcci_legacy.so:system/lib/libqcci_legacy.so \
	vendor/samsung/dali/proprietary/lib/libqmi_client_qmux.so:system/lib/libqmi_client_qmux.so \
	vendor/samsung/dali/proprietary/lib/libomission_avoidance.so:system/lib/libomission_avoidance.so \
	vendor/samsung/dali/proprietary/lib/libfactoryutil.so:system/lib/lib/libfactoryutil.so \
	vendor/samsung/dali/proprietary/lib/libsecnativefeature.so:system/lib/libsecnativefeature.so \
...
PRODUCT_COPY_FILES += \
	...
	vendor/samsung/dali/proprietary/lib/hw/sensors.MSM8660_SURF.so:system/lib/hw/sensors.MSM8660_SURF.so 

# WiFi
PRODUCT_COPY_FILES += \
	vendor/samsung/dali/proprietary/etc/wifi/bcmdhd_sta.bin:system/etc/wifi/bcmdhd_sta.bin \
	vendor/samsung/dali/proprietary/etc/wifi/bcmdhd_mfg.bin:system/etc/wifi/bcmdhd_mfg.bin \
	vendor/samsung/dali/proprietary/etc/wifi/bcmdhd_apsta.bin:system/etc/wifi/bcmdhd_apsta.bin \
	vendor/samsung/dali/proprietary/etc/wifi/bcmdhd_p2p.bin:system/etc/wifi/bcmdhd_p2p.bin \
...
# WiFi b2
PRODUCT_COPY_FILES += \
	vendor/samsung/dali/proprietary/etc/wifi/bcmdhd_sta_b2.bin:system/etc/wifi/bcmdhd_sta_b2.bin \
	vendor/samsung/dali/proprietary/etc/wifi/bcmdhd_mfg_b2.bin:system/etc/wifi/bcmdhd_mfg_b2.bin \
	vendor/samsung/dali/proprietary/etc/wifi/bcmdhd_apsta_b2.bin:system/etc/wifi/bcmdhd_apsta_b2.bin \
	vendor/samsung/dali/proprietary/etc/wifi/bcmdhd_p2p_b2.bin:system/etc/wifi/bcmdhd_p2p_b2.bin \
	vendor/samsung/dali/proprietary/etc/wifi/nvram_net.txt_b2:system/etc/wifi/nvram_net.txt_b2 \
	vendor/samsung/dali/proprietary/etc/wifi/nvram_net.txt_semcove:system/etc/wifi/nvram_net.txt_semcove \
	vendor/samsung/dali/proprietary/etc/wifi/nvram_mfg.txt_b2:system/etc/wifi/nvram_mfg.txt_b2 \
	vendor/samsung/dali/proprietary/etc/wifi/nvram_mfg.txt_semcove:system/etc/wifi/nvram_mfg.txt_semcove
...
# Thermald
PRODUCT_COPY_FILES += \
	vendor/samsung/dali/proprietary/bin/thermald:system/bin/thermald \
	vendor/samsung/dali/proprietary/etc/thermald.conf:system/etc/thermald.conf \
	vendor/samsung/dali/proprietary/lib/libdsm.so:system/lib/libdsm.so \
	vendor/samsung/dali/proprietary/lib/libthermal_mitigation_fusion.so:system/lib/libthermal_mitigation_fusion.so \
	vendor/samsung/dali/proprietary/lib/libthermal_mitigation.so:system/lib/libthermal_mitigation_fusion.so
